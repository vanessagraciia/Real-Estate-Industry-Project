...
for page in N_PAGES:
    website = f"https://www.domain.com.au/rent/melbourne-region-vic/?page={page}"
...
# Print the extracted bedroom numbers
    ...
    df.to_excel(f'rental{page}.xlsx', index=False)
    print(f"Data written to rental{page}.xlsx")
